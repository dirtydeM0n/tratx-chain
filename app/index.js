...
const p2pServer = new P2pServer(bc); // the above blockchain instance is passed
...
p2pServer.syncChains(); //synching the blockchain function
});

app.listen(HTTP_PORT, () => console.log(`Listening on port ${HTTP_PORT}`)); // es6 template string
p2pServer.listen(); // this will start the websocket server in this blockchain application instance